...
const BlueprintPlaceholder: React.FC = () => (
  <div className="flex flex-col items-center justify-center h-64 text-center px-6">
    ...
    <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.4em] mb-2">Start your plan</span>
    <p className="text-[11px] text-white/10 font-light leading-relaxed">Tell us about your space to see <br/>your architectural summary.</p>
  </div>
);
          ...
          <div className="flex-1">
            ...
            {!state.scope ? (
              ...
              <div className="space-y-10">
                ...
                {state.intensity && (
                  <motion.div layout initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}>
                    <span className="text-[10px] text-white/40 uppercase tracking-widest block mb-2 font-bold">Project Use</span>
                    <div className="flex items-center gap-3">
