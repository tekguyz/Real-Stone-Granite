...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-primary border-t border-gold relative z-10">
      {/* Background Noise/Grid (Optional continuity) */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24">
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col gap-3">
              {['Materials', 'Monuments', 'Portfolio'].map((item) => (
                <a 
                  key={item} 
          ...
          <div className="space-y-6">
            ...
            <div className="text-text-muted font-mono text-[10px] uppercase tracking-wider space-y-4">
              <p>&copy; 2026 Real Stone & Granite Corp.</p>
              <p>Authorized Build Access Only.</p>
            ...
            <div className="pt-4 border-t border-white/5">
                <p className="text-[10px] text-white/20 font-mono">
                    PRODUCED BY ARCHITECTURAL INTELLIGENCE
                </p>
            </div>
          </div>
